...
return [(function (){var pred__11338 = cljs.core.instance_QMARK_;
var expr__11339 = reactive_val;
if(cljs.core.truth_(pred__11338.call(null,reagent.ratom.RAtom,expr__11339))){
return "ra";
} else {
if(cljs.core.truth_(pred__11338.call(null,reagent.ratom.RCursor,expr__11339))){
return "rc";
} else {
if(cljs.core.truth_(pred__11338.call(null,reagent.ratom.Reaction,expr__11339))){
return "rx";
} else {
if(cljs.core.truth_(pred__11338.call(null,reagent.ratom.Track,expr__11339))){
return "tr";
} else {
return "other";
}
