...
var len__4789__auto___21727 = arguments.length;
var i__4790__auto___21728 = (0);
while(true){
if((i__4790__auto___21728 < len__4789__auto___21727)){
args__4795__auto__.push((arguments[i__4790__auto___21728]));

var G__21729 = (i__4790__auto___21728 + (1));
i__4790__auto___21728 = G__21729;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq21724){
...
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21725,G__21726,seq21724__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__21730_SHARP_){
return (!((cljs.core.meta.call(null,p1__21730_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.call(null,map__21731__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e21735){var _e__21211__auto__ = e21735;
return false;
}})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
}catch (e21737){var _e__21211__auto__ = e21737;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__21739 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__21740 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__21740);

try{var map__21741 = opts;
...
var markup_db = cljs.core.get.call(null,map__21741__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__21739);
}});
...
var temp__5733__auto___21746 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5733__auto___21746)){
var managed_print_level_21747 = temp__5733__auto___21746;
var _STAR_print_level_STAR__orig_val__21744_21748 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__21745_21749 = managed_print_level_21747;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__21745_21749);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__21743_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__21743_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__21744_21748);
}} else {
job_fn.call(null);
}
