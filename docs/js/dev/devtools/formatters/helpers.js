...
var G__21670 = devtools.prefs.pref.call(null,v);
v = G__21670;
continue;
} else {
return v;
...
}catch (e21673){var _e__21211__auto__ = e21673;
return false;
}})();
...
}catch (e21677){var _e__21211__auto__ = e21677;
return false;
}})();
...
}catch (e21679){var _e__21211__auto__ = e21679;
return false;
}}
}
});
...
var vec__21681 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__21681,(0),null);
var name = cljs.core.nth.call(null,vec__21681,(1),null);
...
return cljs.core.some.call(null,(function (p1__21684_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__21684_SHARP_);
}),template);
});
