...
var ajax$json$make_json_response_format_$_json_response_format__1 = (function (p__13513){
var map__13514 = p__13513;
var map__13514__$1 = (((((!((map__13514 == null))))?(((((map__13514.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__13514.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__13514):map__13514);
var prefix = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13514__$1,cljs.core.cst$kw$prefix);
var keywords_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13514__$1,cljs.core.cst$kw$keywords_QMARK_);
var raw = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13514__$1,cljs.core.cst$kw$raw);
...
var G__13516 = raw;
var G__13517 = keywords_QMARK_;
var G__13518 = ajax.json.strip_prefix(prefix,ajax.protocols._body(xhrio));
return (read_json.cljs$core$IFn$_invoke$arity$3 ? read_json.cljs$core$IFn$_invoke$arity$3(G__13516,G__13517,G__13518) : read_json.call(null,G__13516,G__13517,G__13518));
...
ajax$json$make_json_response_format_$_json_response_format = function(p__13513){
switch(arguments.length){
case 0:
return ajax$json$make_json_response_format_$_json_response_format__0.call(this);
case 1:
return ajax$json$make_json_response_format_$_json_response_format__1.call(this,p__13513);
}
