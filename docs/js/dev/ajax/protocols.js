...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k11344,else__4442__auto__){
var self__ = this;
var this__4441__auto____$1 = this;
var G__11348 = k11344;
var G__11348__$1 = (((G__11348 instanceof cljs.core.Keyword))?G__11348.fqn:null);
switch (G__11348__$1) {
case "status":
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k11344,else__4442__auto__);
...
return cljs.core.reduce.call(null,(function (ret__4461__auto__,p__11349){
var vec__11350 = p__11349;
var k__4462__auto__ = cljs.core.nth.call(null,vec__11350,(0),null);
var v__4463__auto__ = cljs.core.nth.call(null,vec__11350,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__11343){
var self__ = this;
var G__11343__$1 = this;
return (new cljs.core.RecordIter((0),G__11343__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this11345,other11346){
var self__ = this;
var this11345__$1 = this;
return (((!((other11346 == null)))) && ((this11345__$1.constructor === other11346.constructor)) && (cljs.core._EQ_.call(null,this11345__$1.status,other11346.status)) && (cljs.core._EQ_.call(null,this11345__$1.body,other11346.body)) && (cljs.core._EQ_.call(null,this11345__$1.status_text,other11346.status_text)) && (cljs.core._EQ_.call(null,this11345__$1.headers,other11346.headers)) && (cljs.core._EQ_.call(null,this11345__$1.was_aborted,other11346.was_aborted)) && (cljs.core._EQ_.call(null,this11345__$1.__extmap,other11346.__extmap)));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__11343){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__11353 = cljs.core.keyword_identical_QMARK_;
var expr__11354 = k__4447__auto__;
if(cljs.core.truth_(pred__11353.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__11354))){
return (new ajax.protocols.Response(G__11343,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__11353.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__11354))){
return (new ajax.protocols.Response(self__.status,G__11343,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__11353.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__11354))){
return (new ajax.protocols.Response(self__.status,self__.body,G__11343,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__11353.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__11354))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__11343,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__11353.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__11354))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__11343,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4447__auto__,G__11343),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__11343){
var self__ = this;
var this__4438__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__11343,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__11347){
var extmap__4478__auto__ = (function (){var G__11356 = cljs.core.dissoc.call(null,G__11347,new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828));
if(cljs.core.record_QMARK_.call(null,G__11347)){
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,G__11356);
} else {
return G__11356;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__11347),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__11347),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__11347),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__11347),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__11347),null,cljs.core.not_empty.call(null,extmap__4478__auto__),null));
});
