...
if((i < len)){
var k = (ks[i]);
var G__10964 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),goog.object.get(o,k));
var G__10965 = (i + (1));
m = G__10964;
i = G__10965;
continue;
...
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__10967 = c;
var G__10967__$1 = (((G__10967 == null))?null:G__10967.prototype);
if((G__10967__$1 == null)){
return null;
} else {
return G__10967__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__10969 = c;
var G__10969__$1 = (((G__10969 == null))?null:G__10969.prototype);
if((G__10969__$1 == null)){
return null;
} else {
return G__10969__$1.render;
}
})() == null)))));
});
...
var G__10976 = c;
var G__10976__$1 = (((G__10976 == null))?null:G__10976.constructor);
if((G__10976__$1 == null)){
return null;
} else {
return G__10976__$1.displayName;
}
});
...
var _STAR_current_component_STAR__orig_val__10977 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__10978 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__10978);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__10977);
}});
...
var G__10979 = key;
var G__10979__$1 = (((G__10979 instanceof cljs.core.Keyword))?G__10979.fqn:null);
switch (G__10979__$1) {
...
var c = this;
var G__10982_10984 = goog.object.get(c,"cljsRatom");
if((G__10982_10984 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__10982_10984);
}
...
var renders_10985 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_10986 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_10985));
...
if((cljs.core.count.call(null,renders_10985) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_10985))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_10986)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.call(null,render_fun_10986)].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__10987 = o;
goog.object.set(G__10987,cljs.core.name.call(null,k),v);
