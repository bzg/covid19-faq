...
if((i < len)){
var k = (ks[i]);
var G__10427 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__10428 = (i + (1));
m = G__10427;
i = G__10428;
continue;
...
var temp__5737__auto__ = p.argv;
if((temp__5737__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__10429 = p.children;
return reagent.impl.component.global$module$react.Children.toArray(G__10429);
})());
} else {
var v = temp__5737__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__10431 = c;
var G__10431__$1 = (((G__10431 == null))?null:G__10431.prototype);
if((G__10431__$1 == null)){
return null;
} else {
return G__10431__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__10433 = c;
var G__10433__$1 = (((G__10433 == null))?null:G__10433.prototype);
if((G__10433__$1 == null)){
return null;
} else {
return G__10433__$1.render;
}
})() == null)))));
});
...
var G__10435 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__10435) : reagent.impl.component.as_element.call(null,G__10435));
};
...
var G__10441 = c;
var G__10441__$1 = (((G__10441 == null))?null:G__10441.constructor);
if((G__10441__$1 == null)){
return null;
} else {
return G__10441__$1.displayName;
}
});
...
var _STAR_current_component_STAR__orig_val__10442 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__10443 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__10443);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__10442);
}});
...
var G__10444 = key;
var G__10444__$1 = (((G__10444 instanceof cljs.core.Keyword))?G__10444.fqn:null);
switch (G__10444__$1) {
...
var c = this;
var G__10447_10449 = goog.object.get(c,"cljsRatom");
if((G__10447_10449 == null)){
} else {
reagent.ratom.dispose_BANG_(G__10447_10449);
}
...
var renders_10450 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender], null));
var render_fun_10451 = cljs.core.first(cljs.core.vals(renders_10450));
...
if((cljs.core.count(renders_10450) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_10450))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_10451)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_10451], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__10452 = o;
goog.object.set(G__10452,cljs.core.name(k),v);
