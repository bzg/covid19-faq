...
var G__12206 = o;
goog.object.set(G__12206,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__12210 = o;
goog.object.set(G__12210,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__12214 = props;
var G__12214__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12214,cljs.core.cst$kw$id,id):G__12214);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12214__$1,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__12214__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__12215 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12215,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__12215;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__12216){
var map__12217 = p__12216;
var map__12217__$1 = (((((!((map__12217 == null))))?(((((map__12217.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__12217.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__12217):map__12217);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12217__$1,cljs.core.cst$kw$on_DASH_write);
...
return (jsprops.onChange = (function (p1__12219_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__12219_SHARP_);
}));
} else {
return null;
}
...
var vec__12222 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12222,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12222,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12222,(2),null);
...
var temp__5739__auto___12226 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___12226 == null)){
} else {
var key_12227 = temp__5739__auto___12226;
...
var temp__5739__auto___12228 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___12228 == null)){
} else {
var key_12229 = temp__5739__auto___12228;
...
var G__12230 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__12230) : reagent.impl.template.as_element.call(null,G__12230));
} else {
var temp__5739__auto___12231 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___12231 == null)){
} else {
var key_12232 = temp__5739__auto___12231;
(jsprops.key = key_12232);
}
...
var G__12234 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__12234)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__12234)){
return x;
} else {
...
var len__4789__auto___12237 = arguments.length;
var i__4790__auto___12238 = (0);
while(true){
if((i__4790__auto___12238 < len__4789__auto___12237)){
args__4795__auto__.push((arguments[i__4790__auto___12238]));

var G__12239 = (i__4790__auto___12238 + (1));
i__4790__auto___12238 = G__12239;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq12235){
var G__12236 = cljs.core.first(seq12235);
var seq12235__$1 = cljs.core.next(seq12235);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12236,seq12235__$1);
}));
...
var ctx = ({});
var vec__12244 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12244,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12244,(1),null);
...
var G__12247 = (cljs.core.count(argv) - first_child);
switch (G__12247) {
case (0):
...
break;
case (1):
var G__12248 = component;
var G__12249 = jsprops;
var G__12250 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return reagent.impl.template.global$module$react.createElement(G__12248,G__12249,G__12250);
